...
class ActorNetwork:
    ...
    def create_training_method(self):
        ...
        self.parameters_gradients = tf.gradients(ys=self.action_output,xs=self.net,grad_ys=-self.q_gradient_input)
    ...
    def create_network(self, state_dim, action_dim):
        ...
        #action_output = tf.multiply(action_output,high)
    ...
    def target_actions(self,state_batch):
        return self.sess.run(self.target_action_output,feed_dict={self.target_state_input:state_batch})
